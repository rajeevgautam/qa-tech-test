      ...
      <div>
        <Paper style={paperStyle} zDepth={2}>
          ...
          <Paper style={answerStyle}>
                    <TextField id={"submitAnswer1Text"} data-test-id={"submit-1"} hintStyle={rowStyle} hintText="submit challenge 1" underlineShow={false} onChange={(event, value) => this.handleText(event, value, 'answer-1')}/>
            <Divider />
                    <TextField id={"submitAnswer2Text"} data-test-id={"submit-2"} hintStyle={rowStyle} hintText="submit challenge 2" underlineShow={false} onChange={(event, value) => this.handleText(event, value, 'answer-2')}/>
            <Divider />
                    <TextField id={"submitAnswer3Text"} data-test-id={"submit-3"} hintStyle={rowStyle} hintText="submit challenge 3" underlineShow={false} onChange={(event, value) => this.handleText(event, value, 'answer-3')}/>
            <Divider />            
                    <TextField id={"submitAnswer4Text"} data-test-id={"submit-4"} hintStyle={rowStyle} hintText="Your Name" underlineShow={false} onChange={(event, value) => this.handleText(event, value, 'challenger-name')}/>
          </Paper>
          ...
          <p>Good Luck!</p>
                <RaisedButton id={"submitAnswerButton"} label="Submit Answers" primary={true} onClick={this.submitForm}/>
